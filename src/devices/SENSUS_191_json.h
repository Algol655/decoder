...
/*R""""(
{
   ...
   "properties":{
      ...
      "forecast":{
         ...
         "decoder":["string_from_hex_data", "manufacturerdata", 38, 2, true, false]
      }
   }
})""""*/
