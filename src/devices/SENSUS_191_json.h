 ...
 ************************************************************/
const char* _SENSUS_191_9_json = "{\"brand\":\"ALGOL\",\"model\":\"PEMS\",\"model_id\":\"Sensus191\",\"cidc\":false,\"condition\":[\"manufacturerdata\",\"=\",52,\"index\",0,\"ffff55\",\"&\",\"manufacturerdata\",\"index\",50,\"83\"],\"properties\":{\"tvoc_1h_avg_max\":{\"condition\":[\"manufacturerdata\",6,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",6,4,true,false]},\"co2_1h_avg_max\":{\"condition\":[\"manufacturerdata\",10,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",10,4,true,false]},\"co_8h_avg_max\":{\"condition\":[\"manufacturerdata\",14,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",14,4,true,false],\"post_proc\":[\"/\",100]},\"no2_1h_avg_max\":{\"condition\":[\"manufacturerdata\",18,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",18,4,true,false]},\"nh3_8h_avg_max\":{\"condition\":[\"manufacturerdata\",22,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",22,4,true,false]},\"ch2o_8h_avg_max\":{\"condition\":[\"manufacturerdata\",26,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",26,4,true,false]},\"o3_1h_avg_max\":{\"condition\":[\"manufacturerdata\",30,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",30,4,true,false]},\"so2_1h_avg_max\":{\"condition\":[\"manufacturerdata\",34,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",34,4,true,false]},\"c6h6_24h_avg_max\":{\"condition\":[\"manufacturerdata\",38,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",38,4,true,false]}}}";
/*R""""(
{
   "brand":"ALGOL",
   "model":"PEMS",
 ...
 **************************************************************/
const char* _SENSUS_191_10_json = "{\"brand\":\"ALGOL\",\"model\":\"PEMS\",\"model_id\":\"Sensus191\",\"cidc\":false,\"condition\":[\"manufacturerdata\",\"=\",52,\"index\",0,\"ffff55\",\"&\",\"manufacturerdata\",\"index\",50,\"84\"],\"properties\":{\"fw_version\":{\"condition\":[\"manufacturerdata\",6,\"!\",\"ffffffff\"],\"decoder\":[\"string_from_hex_data\",\"manufacturerdata\",6,8,true,false]},\"hw_version\":{\"condition\":[\"manufacturerdata\",14,\"!\",\"ffffffff\"],\"decoder\":[\"string_from_hex_data\",\"manufacturerdata\",14,8,true,false]},\"uptime\":{\"condition\":[\"manufacturerdata\",22,\"!\",\"ffffffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",22,8,true,false]},\"pm2_5_24h_avg_max\":{\"condition\":[\"manufacturerdata\",30,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",30,4,true,false]},\"pm10_24h_avg_max\":{\"condition\":[\"manufacturerdata\",38,\"!\",\"ffff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",38,4,true,false]}}}";
/*R""""(
{
   "brand":"ALGOL",
   "model":"PEMS",
   ...
   "properties":{
      ...
      "uptime":{
         "condition":["manufacturerdata", 22, "!", "ffffffff"],
         "decoder":["value_from_hex_data", "manufacturerdata", 22, 8, true, false]
      },
      "pm2_5_24h_avg_max":{
         "condition":["manufacturerdata", 30, "!", "ffff"],
         "decoder":["value_from_hex_data", "manufacturerdata", 30, 4, true, false]
...
const char* _SENSUS_191_10_json_props = "{\"properties\":{\"fw_version\":{\"unit\":\"\",\"name\":\"fw_version\"},\"hw_version\":{\"unit\":\"\",\"name\":\"hw_version\"},\"uptime\":{\"unit\":\"h\",\"name\":\"uptime\"},\"pm2_5_24h_avg_max\":{\"unit\":\"µg/m³\",\"name\":\"pm25_avg_max\"},\"pm10_24h_avg_max\":{\"unit\":\"µg/m³\",\"name\":\"pm10_avg_max\"}}}";
/*R""""(
{
   "properties":{
      "fw_version":{
